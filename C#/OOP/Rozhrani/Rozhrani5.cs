...
//>>>>>>>>Zároveň i rozhraní 6!!!!<<<<<<
//akorát nemám to ternární rozhraní!!!!!!!!!!!!<<<<<<<<<<<<<< stejně je na h****.. nepřehledné jak sviňa když je to delší
...
namespace Rozhrani5 {
    ...
    class Rozhrani5 {
        public static void Mainx() {
            ...
            //chybí interface + .name

            Console.WriteLine("-----interface-2---");
            for (int i = 0; i <= 4; i++) {
                Console.Write(zv3[i].GetType().Name + " ");
                Console.Write(((Animal)zv3[i]).name);   // <---- toto je to přetypování
                zv3[i].sound();
