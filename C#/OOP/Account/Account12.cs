...
namespace Account12 {
    ...
    class Account {
        ...
        public void transferTo(Account ucet, int castka) {
            ...
            if (castka < 0) {
                throw new MaloPenezException("Nemůžeš posílat mínusové hodnoty " + "zůstatek: " + this.balance);
            }
                ...
                throw new MaloPenezException("nelze posílat 0 " + "zůstatek: " + this.balance);
            }
            else if (this == ucet)
                throw new MaloPenezException("nelz eposílat sám sobě. " + "zůstatek: " + this.balance);
            else {
                ucet.balance += castka;
                this.balance -= castka;
            }
