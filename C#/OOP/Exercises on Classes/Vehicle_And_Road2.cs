...
namespace Vehicle_And_Road2
{
    ...
    class Vehicle_And_Road2
    {
        public static void Mainx()
        {
            ...
            Console.Write("Rychlost: " + v1.speed + " " + v1.GetType().Name);
            v1.writeInfo();

            Console.Write("Rychlost: " + v2.speed + " " + v2.GetType().Name);
            v2.writeInfo();
            Console.Write("Rychlost: " + v3.speed + " " + v3.GetType().Name);
            v3.writeInfo();
            ...
            if (v4 is Tractor)
            {
                Console.Write("Rychlost: " + v4.speed + " " + "Traktůrek");
                v4.writeInfo();
            }
        }
    }
